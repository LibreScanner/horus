...
setting('contrast_value_control', 37, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('saturation_value_control', 12, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('exposure_value_control', 102, int, 'advanced', _('Brightness Value')).setRange(0, 10000)
setting('framerate_value_control', 0, int, 'advanced', _('Brightness Value')).setRange(0, 5)
setting('resolution_value_control', 0, int, 'advanced', _('Brightness Value')).setRange(0, 4)

setting('brightness_value_calibration', 116, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('contrast_value_calibration', 37, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('saturation_value_calibration', 12, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('exposure_value_calibration', 102, int, 'advanced', _('Brightness Value')).setRange(0, 10000)
setting('framerate_value_calibration', 0, int, 'advanced', _('Brightness Value')).setRange(0, 5)
setting('resolution_value_calibration', 0, int, 'advanced', _('Brightness Value')).setRange(0, 4)

setting('brightness_value_scanning', 116, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('contrast_value_scanning', 37, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('saturation_value_scanning', 12, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('exposure_value_scanning', 102, int, 'advanced', _('Brightness Value')).setRange(0, 10000)
setting('framerate_value_scanning', 0, int, 'advanced', _('Brightness Value')).setRange(0, 5)
setting('resolution_value_scanning', 0, int, 'advanced', _('Brightness Value')).setRange(0, 4)
