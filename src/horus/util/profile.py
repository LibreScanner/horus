...
setting('laser_exposure_scanning', 166, int, 'basic', _('Laser Exposure')).setRange(2, 512)
setting('texture_exposure_scanning', 166, int, 'basic', _('Color Exposure')).setRange(2, 512)
