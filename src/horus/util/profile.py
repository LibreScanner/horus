...
setting('brightness_value', 116, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('contrast_value', 37, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('saturation_value', 12, int, 'advanced', _('Brightness Value')).setRange(0, 255)
setting('exposure_value', 102, int, 'advanced', _('Brightness Value')).setRange(0, 10000)
