...
class PatternDistanceWindow(wx.Dialog):
    ...
    def __init__(self, parent):
        super(PatternDistanceWindow, self).__init__(parent, size=(300,200), style=wx.DEFAULT_FRAME_STYLE^wx.RESIZE_BORDER)
        ...
        self.text.Wrap(280)
        self.pattern_text = wx.StaticText(self, label=_('Pattern distance'))
        ...
        hbox2.Add(self.okButton, 0, wx.ALL|wx.EXPAND, 12)
        vbox.Add(hbox2, 0, wx.ALIGN_CENTER_HORIZONTAL,5)
        self.SetSizer(vbox)
