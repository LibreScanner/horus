...
from horus.gui.viewer_3d.gl.trackball import trackball, mulquat, build_rotmatrix
...
class wxGLPanel(wx.Panel):
    ...
    def handle_rotation(self, event):
        if self.initpos is None:
            ...
            quat = trackball(p1x, p1y, p2x, p2y, 4 * self.dist / 250.0)
            with self.rot_lock:
